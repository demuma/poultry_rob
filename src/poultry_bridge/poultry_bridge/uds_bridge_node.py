...
from poultry_bridge import test_frame_pb2 as pb

from poultry_bridge_msgs.msg import TestFrame
from poultry_bridge_msgs.msg import Object as ObjectMsg
...
class UdsProtoToRosBridge(Node):
    def __init__(self, context: Optional[Context] = None):
        ...
        self.publisher = self.create_publisher(TestFrame, "/farm/test_frame", 10)
